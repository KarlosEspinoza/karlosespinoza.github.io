# Material interno del curso de IA
...
| `revision/README.md` | **Los prompts de IA listos para pegar**, semanal y formal |
...
`curso/recursos/`. Este `curso.conf` es lo unico que los hace hablar de IA.

## Convenciones de este curso

| Que | Valor |
|---|---|
| Repo individual | `clasificador-piezas-ia` (semana 1) |
| Repo de equipo | `integrador-ia`, lo crea el representante (semana 4) |
| Repo de autoevaluacion | `autoeval-ia`, uno privado por alumno |
| Commits de la sesion de guia | `sNN bloque 1: ...` / `sNN bloque 2: ...` |
| Carpeta de datos del ciclo | `~/curso/ia/202620/` |
...
1. Llenar `~/curso/ia/202620/alumnos.csv` con el padron y el `usuario` de
