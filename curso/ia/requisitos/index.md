...
| Sensores             | **LDR** + **resistencia 10k ohm** (divisor) |             1 + 1 |
...
| Pasivos              | Resistencias **220 ohm / 330 ohm**            |              5-10 |
| Alimentación         | Cable USB para Arduino                    |                 1 |
| (Opcional pero útil) | Fuente 5V (power bank o adaptador)        |                 1 |

> **Tip:** el **servo SG90** puede meter ruido eléctrico; si quieres blindarte, agrega un capacitor (100-470 uF) entre 5V y GND cerca del servo. (No es obligatorio, pero ayuda mucho en laboratorio.) 
...
| ---------------------------------------------- | --------: | --------------------------------- |
| **Placa perforada (PCB universal)**            |         1 | Tamaño sugerido: 5x7 cm o 7x9 cm  |
| **Headers macho (1x40, cortable)**             | 2-3 tiras | Para señales (A0, D2, D3, etc.)   |
| **Headers hembra (1x40, cortable)**            | 1-2 tiras | Para conectar sensores sin soldar |
